...
/////////////////////////////////////////////////////////////////////////////
// TcpModBusCtrl dialog

class TcpModBusCtrl : public CDialog
{
// Construction
public:
	TcpModBusCtrl(CWnd* pParent = NULL);	// standard constructor
	void CloseDialog( void );				// function for allowing parent to close dialog

// Dialog Data
	//{{AFX_DATA(TcpModBusCtrl)
	enum { IDD = IDD_TCPMODDIAG };
